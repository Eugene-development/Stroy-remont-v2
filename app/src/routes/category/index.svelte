    ...
    <div class="pt-12 sm:pt-16 lg:pt-24">
        <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto space-y-2 lg:max-w-none">
                <h2 class="text-lg leading-6 font-semibold text-gray-300 uppercase tracking-wider">Категория</h2>
                <p class="text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">Продажа строительных материалов</p>
                <p class="text-xl text-gray-300">Компании, продающие строительные и отделочные материалы оптом и в розницу.</p>
            </div>
        </div>
    </div>
                ...
                <div class="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                            <div>
                                <h3 class="inline-flex px-4 py-1 rounded-full text-sm font-semibold tracking-wide uppercase bg-indigo-100 text-indigo-600" id="tier-standard">Дзержинск</h3>
                            </div>
                            <div class="my-4 flex items-baseline text-3xl font-extrabold">
                                Орбита-Строй
                            </div>

                            <div class="my-2 flex text-base text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                </svg>
                                <span class="ml-3">п-т Ленина 121-в</span>
                            </div>
                            <div class="my-2 flex text-base text-gray-500">
                                <svg class="flex-shrink-0 w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                            ...
                            <div class="rounded-md shadow">
                                <a href="#" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900" aria-describedby="tier-standard"> Сайт компании </a>
                            </div>
                        </div>
                    </div>
